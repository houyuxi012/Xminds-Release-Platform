...
func NewManagementVerifier(human, workload, apiToken Verifier) (*ManagementVerifier, error) {
	if human == nil || workload == nil || apiToken == nil {
		return nil, ErrManagementVerifierConfiguration
	}
	return &ManagementVerifier{human: human, workload: workload, apiToken: apiToken}, nil
}

func (verifier *ManagementVerifier) Verify(ctx context.Context, rawToken string) (Principal, error) {
	if verifier == nil || verifier.human == nil || verifier.workload == nil || verifier.apiToken == nil {
